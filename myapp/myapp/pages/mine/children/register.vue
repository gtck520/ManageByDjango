	...
	<view class="register">	
		<view class="content">
			...
			<view class="footer">
				...
				>同意</text>
				<!-- 协议地址 -->
				<navigator url="" open-type="navigate">《协议》</navigator><text>|</text><navigator url="login">已有账号？</navigator>
			</view>
		</view>
	</view>
</template>
